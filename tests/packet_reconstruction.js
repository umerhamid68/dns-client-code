...
var PacketGenerator_1 = require("../src/PacketGenerator");
function testPacketReconstruction() {
    var initialPacket = PacketGenerator_1.PacketGenerator.createPacket('google.com', 'A', 1);
    console.log('Initial Packet:', initialPacket.toString('hex'));
    var reconstructedPacket = PacketGenerator_1.PacketGenerator.reconstructPacket(initialPacket, 'example.com', 'CNAME');
    console.log('Reconstructed Packet:', reconstructedPacket.toString('hex'));
    var extracted = PacketGenerator_1.PacketGenerator.extractPacket(reconstructedPacket);
